...
import org.apache.spark.sql.execution.window.{RangeBoundOrdering, RowBoundOrdering, WindowFunctionFrame}
 ...
 */
case class WindowDirectExec(
    windowExpression: Seq[NamedExpression],
    partitionSpec: Seq[Expression],
    orderSpec: Seq[SortOrder],
    child: DirectPlan)
    extends WindowDirectExecBase(windowExpression, partitionSpec, orderSpec, child) {
